                        ...
                        >
                            ...
                            <div className="user flex flex-col justify-between">
                                <div className="flex relative">
                                    ...
                                    {
                                        unReadCount[user._id] > 0 ? <h2 className={`absolute left-47 ${isMobile && "left-65"} top-7 text-black text-[0.56rem] py-1 bg-green-500 px-2 rounded-2xl`}>{unReadCount[user._id]}</h2> : ""
                                    }
                                    {
